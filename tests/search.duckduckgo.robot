...
Documentation           Demostrate Selenium2Library by searching the web.
...
Search IBM Guadalajara and find a reference for this site
    ...
    Search and check results     ibm guadalajara      www.ibm.com/mx-es

Search Robot Framework and find a reference for this site
    [Tags]      robot framework      smoke
    Search and check results     robot framework      robotframework.org

Search DevOps Days in Guadalajara and find a reference for this site
    [Tags]      robot framework      smoke
    Search and check results     devopsdays guadalajara      devopsdays events
